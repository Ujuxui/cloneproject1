...
const Header = () => {
    ...
    <>
      <div className="mainheader 2xl:container mt-4 mb-4">
        <div className="w-[90%] mx-auto grid grid-cols-1 md:grid-cols-3 h-[100%]">
          ...
          <div className="navbar justify-center items-center space-x-8 h-[100%] text-lg">
            <div className="maintab">Stays</div>
            <div className="experiencestab opacity-40"><Link to="/experiences">Experiences</Link></div>
      ...
      <div>
        <div className="flex justify-center display-center mt-4 mb-6">
          <div className="searchbar w-[55%] mx-auto border bg-white shadow-lg rounded-full">
  ...
  <div className="w-[90%] mx-auto flex mt-4 space-x-10">
    <div className="filter-div w-[80%] object-contain flex overflow-x-auto overflow-y-hidden ml-10 mt-4 h-20 gap-10">
      {links.map((item, i) => (
        <div className="icon-wrapper transition-opacity duration-300 ease-in-out opacity-50" key={i}>
            <img className="w-max h-6" src={item.imgSrc} alt={item.label} />
